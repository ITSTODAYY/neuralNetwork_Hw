...
class Model:
    def __init__(self,
        ...
        self.loss_val, self.pred_val, self.acc_val = self.forward(True, tf.AUTO_REUSE)
    ...
    def forward(self, is_train = True, reuse=None):
        ...
        with tf.variable_scope("model", reuse=reuse):
            ...
            # Your Linear Layer
            out = tf.layers.dense(self.x_, units = 400, name = "linear1")
            ...
            # Your Linear Layer
            logits = tf.layers.dense(out, units = 10, name = "linear2")
